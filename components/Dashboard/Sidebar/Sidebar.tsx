        ...
        <ul>
          <li className="mb-2">
            <div
              ...
              className="flex items-center gap-2 text-blue-300 hover:text-blue-500 transition-all duration-300 cursor-pointer"
            >
              ...
              {brands?.map((brand: any, i: number) => (
                <li key={brand?.id} className="mb-1">
                  <div
                    ...
                    className="flex items-center text-blue-300 hover:text-blue-500 transition-all duration-300 cursor-pointer"
                  >
                    <svg
