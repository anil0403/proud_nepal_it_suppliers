        ...
        <>
            <div className='m-1 text-gray-800 flex flex-row justify-center items-center'>
                <div className='text-center pt-2'>
                    <h1 className='font-bold text-lg md:text-2xl'>Proud Nepal IT Suppliers Pvt. Ltd.</h1>
                    <p className='font-semibold'>Putalisadak, Kathmandu</p>
                </div>
                <div className='flex flex-col items-end pr-2 absolute right-2'>
                    <p className='font-semibold flex flex-row items-center gap-2'> <RiAdminFill /> {user?.email}</p>
                    <div onClick={() => { signOut() }} className='flex items-center gap-2 hover:cursor-pointer'>
                        <BiLogOut size={20} />
